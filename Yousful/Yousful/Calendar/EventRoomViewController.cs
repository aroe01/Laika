...
namespace Yousful.Calendar{
	...
	[Register("ImageView")]
	public partial class EventRoomViewController : UIViewController {

		UIImagePickerController imagePicker;

		[Outlet]
		UIButton choosePhotoButton {get; set;}
		...
		public EventRoomViewController (RootViewController p, int eId)
		{
